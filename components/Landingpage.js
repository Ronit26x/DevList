        ...
        >
          ...
          <div className="landing-page-details">
            <div className="heading-text second">
              ...
              <p>
                Power up your website with awesome tools from CSS generators and
                stock photos, to icons, illustrations, vectors and so much more,
                all at one place
              </p>
            </div>
            <div className="header-image">
          ...
          <div className="landing-page-details">
            <div className="heading-text second">
              ...
              <p>
                Looking for a backend service for your next project? We've got
                you covered with a list of the best ones out there!
              </p>
            </div>
            <div className="header-image">
